    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dynamic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Dynamic Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dynamic Core is shutting down...") + "<br /><br />" +
